...
const PreviewForm: React.FC = () => {
  ...
  return (
    ...
    <Paper elevation={3} sx={{ p: { xs: 2, sm: 3, md: 4 }, border: '1px solid black' }}>
      ...
      {basicsContent && (
        <Box mb={4}>
          ...
          <Box sx={{ mb: 2 }}>
              ...
              {basicsContent.website && <Typography variant="body1"><strong>Website:</strong> <a href={basicsContent.website} target="_blank" rel="noopener noreferrer">{basicsContent.website}</a></Typography>}
          </Box>
      ...
      {/* Profiles */}
      {profilesContent && (
        <Box mt={hasRenderedPreviousSection && basicsContent ? 0 : 4} mb={4}>
           {hasRenderedPreviousSection && basicsContent && <Divider sx={{ mb: 3 }} />}
           {profilesContent}
           {(hasRenderedPreviousSection = true)}
        </Box>
      )}
      ...
      {/* Experience */}
      {experienceContent && (
         <Box mt={hasRenderedPreviousSection && (basicsContent || profilesContent) ? 0 : 4} mb={4}>
           {hasRenderedPreviousSection && (basicsContent || profilesContent) && <Divider sx={{ mb: 3 }} />}
           {experienceContent}
           {(hasRenderedPreviousSection = true)}
         </Box>
      )}
      ...
      {/* Education */}
      {educationContent && (
        <Box mt={hasRenderedPreviousSection && (basicsContent || profilesContent || experienceContent) ? 0 : 4} mb={4}>
           {hasRenderedPreviousSection && (basicsContent || profilesContent || experienceContent) && <Divider sx={{ mb: 3 }} />}
           {educationContent}
           {(hasRenderedPreviousSection = true)}
        </Box>
      )}
      ...
      {/* Skills */}
      {skillsContent && (
         <Box mt={hasRenderedPreviousSection && (basicsContent || profilesContent || experienceContent || educationContent) ? 0 : 4} mb={4}>
           {hasRenderedPreviousSection && (basicsContent || profilesContent || experienceContent || educationContent) && <Divider sx={{ mb: 3 }} />}
           {skillsContent}
           {(hasRenderedPreviousSection = true)}
         </Box>
      )}
      ...
      {/* Projects */}
      {projectsContent && (
        <Box mt={hasRenderedPreviousSection && (basicsContent || profilesContent || experienceContent || educationContent || skillsContent) ? 0 : 4} mb={4}>
           {hasRenderedPreviousSection && (basicsContent || profilesContent || experienceContent || educationContent || skillsContent) && <Divider sx={{ mb: 3 }} />}
           {projectsContent}
        </Box>
      )}
