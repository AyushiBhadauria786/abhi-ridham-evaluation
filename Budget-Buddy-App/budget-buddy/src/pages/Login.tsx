  ...
  return (
    ...
    >
      ...
      <Paper
        ...
        elevation={3}
        sx={{ padding: 4, width: "100%", maxWidth: 420, borderRadius: 3, boxShadow: "0 4px 12px rgba(0,0,0,0.05)" }}
      >
        <Typography variant="h5" fontWeight={700} textAlign="center" mb={1}>Welcome Back!</Typography>
        ...
        <Box sx={{ mb: 2 }}>
          ...
          <input
            ...
            style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: "1px solid #ccc", backgroundColor: "#eef3fd", fontSize: 14, outline: "none" }}
          />
        </Box>
        ...
        {error && <Typography color="error" variant="body2" textAlign="center" my={2}>{error}</Typography>}
        ...
        <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mt: 1, mb: 2 }}>
          ...
          <Link href="#" underline="hover" fontSize={14}>Forgot password?</Link>
        </Box>

        <Button
          fullWidth type="submit" variant="contained" disabled={loading}
          sx={{ background: "linear-gradient(to right, rgb(71, 85, 105), rgb(37, 99, 235))", textTransform: "none", fontWeight: "bold", fontSize: "16px", py: 1.3, borderRadius: 2, ":hover": { backgroundColor: "rgb(55, 65, 81)" } }}
        >
